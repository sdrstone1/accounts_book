...
public class Settings_View extends Settings_Module {
    ...
    public void onBuildHeaders(List<Header> target) {
        loadHeadersFromResource(R.xml.v_pref_headers, target);
    }
    ...
    public static class GeneralPreferenceFragment extends PreferenceFragment {
        ...
        public void onCreate(Bundle savedInstanceState) {
            super.onCreate(savedInstanceState);
            addPreferencesFromResource(R.xml.v_pref_general);
            ...
            // guidelines.
            Preference preference = findPreference("SMSReg");
            sBindPreferenceSummaryToValueListener.onPreferenceChange(preference,
                    PreferenceManager
                            .getDefaultSharedPreferences(preference.getContext())
                            .getBoolean(preference.getKey(), false));
            //bindPreferenceSummaryToValue(findPreference("SMSReg"));
